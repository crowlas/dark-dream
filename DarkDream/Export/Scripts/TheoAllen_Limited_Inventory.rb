...
module Theo
  ...
  # --------------------------------------------------------------------------
    ...
    InvSlotVocab    = "Inventaire: "   # Inventory Vocab
    InvSizeVocab    = "Taille de l'objet: "   # Item size / weight
    SlotVocabShort  = "Inv:"          # Abbreviation for Inventory
    UseVocab        = "Utiliser l'objet"      # Use item
    DiscardVocab    = "Jeter l'objet"  # Discard Item
    CancelVocab     = "Annuler"        # Cancel
